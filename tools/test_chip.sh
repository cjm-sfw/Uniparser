...
CUDA_VISIBLE_DEVICES=0 python tools/test_chip.py work_dirs/CIHP_release_r101_fpn_8gpu_3x_offset_parsing_v1/DCN/CHIP_r101_fpn_8gpu_3x_offset_parsing_v1_ori_grid_unified_DCN.py work_dirs/CIHP_release_r101_fpn_8gpu_3x_offset_parsing_v1/DCN/epoch_28.pth --show --eval 'parsing'
