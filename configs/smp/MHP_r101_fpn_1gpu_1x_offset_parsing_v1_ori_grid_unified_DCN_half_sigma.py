...
# optimizer
optimizer = dict(type='SGD', lr=0.015/8, momentum=0.9, weight_decay=0.0001)
...
log_level = 'INFO'
work_dir = './work_dirs/MHP_release_r101_fpn_1gpu_1x_offset_parsing_v1/ori_gird_DCN_1x_half_sigma/'
load_from = None
resume_from = "/mnt/SMP2.0/multi-parsing/work_dirs/MHP_release_r101_fpn_1gpu_1x_offset_parsing_v1/ori_gird_DCN_1x_half_sigma/epoch_6.pth"
workflow = [('train', 1)]
