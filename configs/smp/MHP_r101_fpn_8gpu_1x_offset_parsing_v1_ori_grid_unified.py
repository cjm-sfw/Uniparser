...
train_pipeline = [
    ...
    dict(type='Resize_Parsing',
         ...
         keep_ratio=True),
    dict(type='RandomFlip_Parsing', flip_ratio=0.5, dataset='mhp'),
...
test_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='RandomFlip_Parsing', dataset='mhp'),
            dict(type='Normalize', **img_norm_cfg),
            dict(type='Pad_Parsing', size_divisor=32),
...
log_level = 'INFO'
work_dir = './work_dirs/MHP_release_r101_fpn_8gpu_1x_offset_parsing_v1/ori_gird_1x/'
load_from = None
resume_from = None
workflow = [('train', 1)]
