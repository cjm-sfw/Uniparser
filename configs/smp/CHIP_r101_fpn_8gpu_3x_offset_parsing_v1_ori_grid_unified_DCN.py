...
lr_config = dict(
    ...
    warmup='linear',
    warmup_iters=500,
    warmup_ratio=(lr_base*data['samples_per_gpu'] * nums_gpu),
    step=[19, 25])
...
log_level = 'INFO'
work_dir = './work_dirs/CIHP_release_r101_fpn_8gpu_3x_offset_parsing_v1/DCN/'
load_from = "./work_dirs/CIHP_release_r101_fpn_8gpu_3x_offset_parsing_v1/DCN/epoch_8.pth"
resume_from = None
workflow = [('train', 1)]
